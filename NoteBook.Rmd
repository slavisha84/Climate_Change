...
While every event in the system in naturaly-logical cosenquence of the even that prior, as a civilization "Type 0" we might not be able to influnece Sun`s radiation spectrum but we can adjust our own behaviour according the forecasting from studies similar to this one.   
