...
3. What is temperature trend for city of residence ( Atlanta)?
...
6. What are key effects of global warming?
...
**Raise of the ocean temperature**
...
Based on the Average Temperature Graph bellow, we can see that average temperature of the land has been significantly increasing with higher rate than temperature of the ocean. Oceans are heating and cooling much faster than land due to low density of the water. There are few factors that could cause average land temperature to increase with higher rate than ocean average temperature. With rapid deforestation, we reduce absorption of greenhouse gases that fuel global warming. Fewer forest will allow larger amounts of greenhouse gases to enter the atmosphere(~15% carbon) and trap the solar rays and heat up the surface that once has been protected by forest. Industrial effects within developed and developing countries plays the significant role where emission of greenhouse gasses (CO and CO2) directly influences speed and severity of the temperature in those regions and globally as well. The United States constitutes 5% of the world population and contributes to 22% of world’s crbon emission. 
...
##Min and Max Average Temperature Trends
...
In Graph below we can se the amplitudes of change for these extremes. It is clear that both temperature extremes across century and half are slightly increasing with corelation of ~90%. 
...
The Graph bellow illustrates the change in global surface temperature relative to 1850-2013 average temperatures. Threeteen of the warmest years in the 163-year record all have occurred since 2000. 
...
With given average temperature for every major city, on Bar chart bellow we have top 10 coldest cities in the world with descending rank. 
...
While we have drastic difference between top 10 coldest major cities in the world, the top 10 cities are very similar in comparasing with average temperature across century and half.  
...
Using longitude and latitude informations for given data, we can plot the locatin of top 10 coldest and top 10 hotest cities on the world map. It is interesting to see that all coldest cities, with excpetion to Santiago, are scatered at norhter hemisphere. Top 10 hotest cities are scatered over the south hemisphere. 
...
Based on World Map with average temperature changes, we can see that most significant temperature increase is measured in develoeped countries. It is expected for these countries to be the one who produces most of the greenhouse gasses such as some of these below:
...
Since this is a city of my residence I am going to explore the trend of Average temperature between 1850 and 2013
...
Using the temperature data set from every city, we are going to explore seasonality trend for years between 1850 and 2013
...
With giving sets of data we have level of uncertainity due to imperfections in measurements and collection of the average temperature. Based on graph below we can see that between 1850 and 1975 we have decline of uncertainity from 1.5% below 0.5%. The reliability of data stabilizes from 1975 with exception to two outliers in 2013. 
